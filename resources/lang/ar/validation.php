...
return array(
    ...
    'attributes' => array(
        ...
        "description" => "الوصف",
        "grade" => "الدرجة",
        "best_answer" => "الإجابة الصحيحة",
        "answers" => "الإجابة الخاطئة",
        "title" => "العنوان",
        "description" => "الوصف",
        ...
        "question_choose" => "اختيار الأسئلة",
        "phone" => "رقم الجوال",
        "professional_specialization"=>"التخصص المهني",
        "work_location"=>"جهة العمل",
        "image"=>"الصورة",
        "accept"=>"أوافق علي اللائحة العامة للجمعية",
        "gender"=>"النوع",
        "subject"=>"الموضوع",
        "message"=>"الرسالة",
